...
from experiments.phase_1_foundation.exp_a_foundation import InterleavedSequenceDataset, SimpleTransformer, train_epoch, evaluate
...
def run_stroke_test(
    ...
    # Save
    with open("data/exp_1a_stroke_results.json", 'w') as f:
